...
// Generate embeddings using Mixedbread API
async function generateEmbedding(text: string): Promise<number[]> {
  const apiKey = process.env.MIXEDBREAD_API_KEY
  if (!apiKey) {
    throw new Error("Missing Mixedbread API key. Add MIXEDBREAD_API_KEY to .env.local")
  }
...
async function updateVectorDatabase() {
  console.log("🚀 Starting Upstash Vector Database Update with Mixedbread Embeddings...")
  ...
  try {
    ...
    console.log("🔄 Generating embeddings with Mixedbread AI...")
